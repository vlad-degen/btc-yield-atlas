...
- **Re-check against the sources, 24 September.** All 88 rows taken from DefiLlama series equal DefiLlama's 2026-09-20 point (differences only where this study nets double counts: Veda, Ember, Belt, Convex, Badger, Zest's STBTC, IPOR's Tesseract vaults). Read again four days later the median row moved 0.3%; Babylon 41,329 → 40,293 BTC (Babylon's site: 40,365 active), Kraken's vault 6,492 → 6,609 (on-chain), ether.fi 232 → 239, Yield Basis and Bitget unchanged; Volo −21%, Hyperbeat Earn −16%, Native +23%. Gate: the Gate Earn finality provider held 3,485 BTC and GTBTC supply 3,456 on-chain, while Gate's own page showed 2,790 BTC staked. The page keeps the 20 September snapshot and shows the re-check in its Data section.
